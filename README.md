...
The latest Beta release of SoloBill is available here:
[Access SoloBill Online](https://solobill.higginscompany.com)

You can **install it to your device** like any PWA:

1. install (Chrome Example)):

<img src="docs/images/solobill_install.png" alt="Solobill Install" width="500"/>

2. uninstall: [chrome://apps](chrome://apps)
